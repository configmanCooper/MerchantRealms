        ...
        // Ch 12b — Bonds of the Realm (NPC Relationships Tutorial)
        {
            ...
            objectives: [
                { id: 'ch12b_talk_npc', type: 'custom', fn: '_checkTalkedToNPC',
                  ...
                  hint: 'Open the World menu and click Town View, then click View Townspeople to see everyone in town. Click on any person and choose Talk.',
                  done: false },
                { id: 'ch12b_gift_npc', type: 'custom', fn: '_checkGiftedNPC',
                  desc: 'Give a gift to someone',
                  hint: 'Open the World menu and click Townspeople (or Town View → View Townspeople). Click on a person, then click Gift to offer them something from your inventory.',
                  done: false },
                ...
                { id: 'ch12b_go_on_date', type: 'custom', fn: '_checkWentOnDate',
                  ...
                  hint: 'Open Townspeople from the World menu, click on someone you have a Friendly (20+) relationship with, and choose Date.',
        ...
        if (objId === 'ch16_reach_noble') {
            ...
            try {
                ...
                if (_valdrenK2) {
                    ...
                    _log('Scheduled royal court for day ' + _courtDay + ' after feast completion');
                }
