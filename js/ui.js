...
window.UI = (function () {
    ...
    function bindEvents() {
        ...
        registerAction('openKingPanel', function(_t, d) { if (UI.openKingPanel) UI.openKingPanel(d.tab || undefined); });
        ...
        try {
            ...
            if (typeof Player !== 'undefined') {
                ...
                if (btnNobility) {
                    ...
                    btnNobility.style.display = _nobleRank >= 4 ? '' : 'none';
                    if (_nobleRank >= 4) {
