...
var Guidance = (function () {
    ...
    var TASK_TOOLTIPS = {
        ...
        buy_food: 'Click the Trade button in the action bar at the bottom to open the market. Buy food like bread, meat, or fish.',
        buy_water: 'Click the Trade button in the action bar at the bottom to open the market. Buy water, ale, or other drinks.',
        ...
        earn_100g: 'Earn gold by doing jobs (town view → Jobs tab), trading goods (Trade button in the action bar), or selling items at the market.',
        first_trade: 'Click the Trade button in the action bar at the bottom to open the market. Buy goods that are cheap here to sell in other towns.',
        travel_nearby: 'Right-click a town on the map to travel there, or use the Routes button in the action bar to see connected towns and distances.',
        ...
        hire_guard: 'Click your town name → View Townspeople to find guards for hire. You can also zoom in on the map and click NPCs directly, or check the Character menu Guards section.',
        ...
        buy_cheap_good: 'Click the Trade button in the action bar at the bottom to open the market. Look for goods priced below their base value.',
        sell_expensive_good: 'Click the Trade button in the action bar at the bottom to open the market. Sell goods that are priced above their base value here.',
        ...
        earn_1000g: 'Keep trading between towns using the Trade button and running your businesses. Selling processed goods like bread or furniture earns the most profit.',
        ...
        hire_worker: 'Click your town name → View Townspeople to find workers, then click Hire. You can also use the Buildings button and click Hire Worker on your building.',
        ...
        complete_10_trades: 'Keep buying and selling using the Trade button in the action bar. Each purchase or sale counts as one trade. Visit multiple towns for the best deals.',
        ...
        build_second_town: 'Right-click a town on the map or use the Routes button to travel there. Then buy land (Housing tab) and build a new building.',
        ...
        join_second_guild: 'Right-click a town on the map or use the Routes button to travel to a town with a different guild. Each guild offers unique crafting recipes and trade benefits.',
        '8_workers': 'Click your town name → View Townspeople to find workers for hire. You can also use the Buildings button and click Hire Worker on each building.',
        complete_50_trades: 'Keep buying and selling using the Trade button. Use trade tips from Info Brokers and compare prices between towns to find the best deals.',
        build_relationship_60: 'Click your town name to open the town view, then View Townspeople to find NPCs. Click on one to interact — use Small Talk, give gifts, or do favors. You can also zoom in on the map and click NPCs directly.',
        ask_npc_favor: 'Click your town name → View Townspeople, then select an NPC with 60+ relationship. Choose Favors from their interaction options. You can also zoom in on the map and click NPCs directly.',
