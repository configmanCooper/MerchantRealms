...
const BUILDING_TYPES = {
    ...
    WEAVER:        { id: 'weaver',        name: 'Weaver',        cost: 300,  workers: 2, produces: 'cloth',    consumes: { wool: 2 },              rate: 5, category: 'processing', storage: 50, materials: { wood: 10, planks: 5 }, canProduce: ['cloth', 'rope'],
        availableProducts: {
...
const SKILLS = {
    ...
    black_market_contacts: { name: 'Black Market Contacts', branch: 'underworld', cost: 4, requires: ['master_smuggler'],         desc: 'Black market premium increased to 2x (from 1.5x). -10% street buy prices.',                        icon: '🕶️' },
