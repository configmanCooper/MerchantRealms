...
const CONFIG = {
    ...
    SOLDIER_RECRUIT_COST: 50,              // v9p33river399: gold per soldier recruited
    WAR_DECLARATION_COST: 300,             // v9p33river399: treasury cost to declare war
    ...
    // v9p33river442: Noble Memory System
    NOBLE_MEMORY_PLAYER_MAX_DIM: 15,
    NOBLE_MEMORY_PLAYER_MAX_NORMAL: 30,
    NOBLE_MEMORY_PLAYER_MAX_BRILLIANT: 50,
    NOBLE_MEMORY_NOBLE_MAX_DIM: 50,
    NOBLE_MEMORY_NOBLE_MAX_NORMAL: 100,
    NOBLE_MEMORY_NOBLE_MAX_BRILLIANT: 150,
    NOBLE_MEMORY_ACTIONABLE_DAYS: 90,     // Declarations actionable for AI for 90 days
    NOBLE_MEMORY_OBSERVATION_SAME_TOWN: 0.70,
    NOBLE_MEMORY_OBSERVATION_DIFF_TOWN: 0.15,
    NOBLE_MEMORY_INTEL_BRILLIANT_BONUS: 0.20,
    NOBLE_MEMORY_INTEL_DIM_PENALTY: 0.15,
    NOBLE_MEMORY_AMBITION_BONUS: 0.10,
    NOBLE_MEMORY_LOYALTY_BONUS: 0.10,
    NOBLE_MEMORY_DEDUP_DAYS: 3,
    NOBLE_MEMORY_AI_COALITION_SUPPORTIVE: 0.08,
    NOBLE_MEMORY_AI_COALITION_HOSTILE: 0.06,
    NOBLE_MEMORY_AI_COALITION_CURRY: 0.05,
    NOBLE_MEMORY_AI_ASK_AROUND: 0.03,
    ...
    ENFORCEMENT_BASE_DETECTION: 0.10,
    ...
    ENFORCEMENT_MIN_DETECTION: 0.01,
    ...
    HOUSING_TYPES: [
        ...
        { id: 'merchant_house', name: 'Merchant House', icon: '🏘️', laborCost: 200, storage: 150, security: 0.6, restBonus: 0.8, maxOccupants: 8, comfort: 65, diseaseReduction: 0.45, minTownCategory: 'town', repBonus: 10, hasWorkshop: true,
          materials: { planks: 25, stone: 15, bricks: 10, iron: 4, cloth: 3, furniture: 4 },
        ...
        { id: 'manor', name: 'Manor House', icon: '🏛️', laborCost: 500, storage: 300, security: 0.8, restBonus: 0.9, maxOccupants: 12, comfort: 80, diseaseReduction: 0.55, minTownCategory: 'city', repBonus: 20, hasWorkshop: true, hasStables: true,
          materials: { planks: 40, stone: 30, bricks: 20, iron: 8, cloth: 5, furniture: 8 },
        ...
        { id: 'estate', name: 'Noble Estate', icon: '🏰', laborCost: 1200, storage: 500, security: 0.95, restBonus: 1.0, maxOccupants: 20, comfort: 95, diseaseReduction: 0.70, minTownCategory: 'city', repBonus: 35, hasWorkshop: true, hasStables: true, hasGarden: true, minRank: 4,
          materials: { planks: 60, stone: 50, bricks: 35, iron: 15, cloth: 10, furniture: 12 },
...
const RESOURCE_TYPES = {
    ...
    COAL:             { id: 'coal',              name: 'Coal',             category: 'raw',       basePrice: 8,  icon: '⬛', weight: 2 },
...
const BUILDING_TYPES = {
    ...
    SMELTER:       { id: 'smelter',       name: 'Smelter',       cost: 400,  workers: 3, produces: 'iron',     consumes: { iron_ore: 2, wood: 1 }, rate: 4, category: 'processing', storage: 60, optionalBoost: { resource: 'charcoal', alternates: ['coal'], bonusPct: 25, consumeRate: 1, storageName: 'Charcoal/Coal Storage', storageMax: 30 }, materials: { stone: 20, bricks: 5, iron: 2 }, canProduce: ['iron', 'steel', 'steel_from_coal'],
        availableProducts: {
            iron:            { produces: 'iron',  consumes: { iron_ore: 2, wood: 1 },      rate: 4 },
            steel:           { produces: 'steel', consumes: { iron: 2, charcoal: 1 },      rate: 2 },
            steel_from_coal: { produces: 'steel', consumes: { iron: 2, coal: 1 },          rate: 2, name: 'Steel (from Coal)' },
        },
    },
    ...
    COAL_MINE:     { id: 'coal_mine',     name: 'Coal Mine',     cost: 450,  workers: 4, produces: 'coal',            consumes: {},                          rate: 5, category: 'mine',       storage: 80, materials: { wood: 18, stone: 12, tools: 3 }, icon: '⬛', description: 'Extracts coal from mountain deposits. Valued by industrial kingdoms as a high-energy fuel.' },
    POWDER_WORKS:  { id: 'powder_works',  name: 'Powder Works',  cost: 600,  workers: 3, produces: 'saltpeter',       consumes: { manure: 4 },               rate: 3, category: 'processing', storage: 40, materials: { stone: 15, bricks: 10, wood: 8 }, icon: '💣', description: 'Refines manure into saltpeter and mixes blasting powder from saltpeter, charcoal/coal, and sulfur.',
        canProduce: ['saltpeter', 'blasting_powder', 'blasting_powder_from_coal'],
        availableProducts: {
    ...
    APOTHECARY:       { id: 'apothecary',       name: 'Apothecary',      cost: 400,  workers: 1, produces: 'herbal_remedy',  consumes: { herbs: 3 },                rate: 2, category: 'medical',   storage: 30, materials: { wood: 8, stone: 5 }, icon: '⚗️', description: 'Produces medicines and remedies from herbs. Healing Tonic requires level 3+. Antidotes require an Advanced Apothecary.',
        canProduce: ['herbal_remedy', 'herbal_poultice', 'healing_tonic', 'fever_tonic', 'poison', 'blasting_powder', 'blasting_powder_from_coal', 'saltpeter'],
        availableProducts: {
    ...
    ADVANCED_APOTHECARY: { id: 'advanced_apothecary', name: 'Advanced Apothecary', cost: 800, workers: 3, produces: 'healing_tonic', consumes: { herbs: 4, honey: 1 }, rate: 2, category: 'medical', storage: 60, materials: { stone: 15, wood: 12, planks: 8, iron: 3 }, icon: '🧬', description: 'A full-service medical laboratory. Produces all medicines including antidotes and tonics at higher rates.', minTownCategory: 'town',
        canProduce: ['herbal_remedy', 'herbal_poultice', 'healing_tonic', 'fever_tonic', 'splint', 'antidote', 'poison', 'blasting_powder', 'blasting_powder_from_coal', 'saltpeter'],
        availableProducts: {
            ...
            blasting_powder_from_coal: { produces: 'blasting_powder', consumes: { saltpeter: 2, coal: 1, sulfur: 1 },     rate: 3, name: 'Blasting Powder (from Coal)' },
        },
    },
...
const SKILLS = {
    ...
    noble_agendas:       { name: 'Noble Agendas',       branch: 'social',     cost: 3, requires: ['noble_assets'],               desc: 'Reveals noble political agendas, personal goals, and what they advise the king. Shows their influence rating.',  icon: '🏛️' },
    merchant_agendas:    { name: 'Merchant Agendas',    branch: 'social',     cost: 3, requires: ['noble_assets'],               desc: 'Reveals elite merchant business agendas — strategy goals, expansion plans, concerns, and market influence.',     icon: '📊' },
...
const NPC_HEALTH_CONFIG = {
    ...
    ILLNESSES: {
        ...
        // v9p33river257: poison drain 5 → 10 (deadly toxin).
        // Untreated (age 18-30): 10 × 3 = 30/tick = 10/d
        //   d3: 55hp, d6: 25hp, d9: dead
        // Treated hospital (× 0.40 mult, no natural heal, 12-day cure +20):
        //   per-tick treated drain = 30 × 0.40 = 12 = 4/d net
        //   12-day cure window loses 48hp
        //   Treated d3 (55hp) → 7hp at cure → +20 = 27hp survives (close)
        //   Treated d6 (25hp) → would hit 0 by d12, dies before cure
        //   Treated d9: already dead
        // Practical outcomes:
        //   • Get to hospital within 3 days = ~80% survive
        //   • 4-6 days = coin flip
        //   • 7+ days = nearly always dies
        //   • Untreated = dead by day 9 (no recovery rolls in time)
        poisoned:       { name: 'Poisoned',             severity: 'severe',   healthDrain: 10.0, daysToRecover: 30, seasons: ['spring', 'summer', 'autumn', 'winter'], contagious: false, naturalRecoveryDay: 15, naturalRecoveryChance: 0.05, recoveryChance: 0.15 },
    },
...
CONFIG.NATURAL_DEPOSITS = {
    ...
    // v9p33-deposits: added so survey scaling is consistent (was falling back to flat hits*200)
    coal:       { min: 5000, max: 14000, terrain: 'mountain', renewable: false },
    pearls:     { min: 800,  max: 2500,  terrain: 'coastal', renewable: true, regenPerDay: 1 },
};
...
CONFIG.DEPOSIT_REQUIREMENTS = {
    ...
    coal_mine:    { deposit: 'coal',     label: 'Coal Deposit' },
    pearl_diver:  { deposit: 'pearls',   label: 'Pearl Beds' },
};
...
CONFIG.KINGDOM_BUILDING_TYPES = [
    ...
    'charcoal_kiln', 'coal_mine', 'sulfur_mine',
